...
// --- START: REFINED UI Helper Components ---

// Placeholder Icons (Using a slightly different look to signal decency)
const JobIcon = <span className="text-xl font-bold font-serif">J</span>;
const CandidateIcon = <span className="text-xl font-bold font-serif">C</span>;

/**
 * 1. REFINED KPI Card Component
 * - Uses shadow-lg for depth and rounded-2xl for soft corners.
 */
  ...
  <div className="bg-white shadow-xl rounded-xl border border-gray-100 p-6 transition-all duration-300 hover:shadow-2xl">
    <div className="flex items-start justify-between">
      <div>
        ...
        <p className={`text-5xl font-extrabold mt-1 ${colorClass} tracking-tight`}>{value}</p>
      </div>
...
const Dashboard = () => {
    ...
    const loadJobs = async () => {
        // ... (loadJobs logic remains unchanged, keeping mock data for demo)
        try {
        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <KpiCard
                    ...
                    icon={CandidateIcon}
                    colorClass="text-blue-700" // Deeper Blue
                />
                <KpiCard
                        ...
                        {jobs.map((job) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* --- 2. REFINED PROGRESS WIDGET --- */}
                                    <div className="mt-4 mb-5">
                                        <div className="flex justify-between text-sm text-gray-600 mb-1">
                                            <span className="font-semibold text-gray-800">{job.candidates_in_review || 0} Candidates</span>
                                            <span>({progressPercentage}%)</span>
                                        </div>
                                        {/* Progress Bar with cleaner colors */}
